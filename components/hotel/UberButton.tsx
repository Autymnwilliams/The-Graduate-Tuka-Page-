...
// Uber's brand mark, sourced from Simple Icons (MIT-licensed, maintained to
// match each company's actual current logo -- used here the same way many
// production apps embed it, for a "link out to Uber" button, not to imply
// partnership). fill="currentColor" so it inherits the button's text color.
function UberLogo() {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 shrink-0" fill="currentColor" aria-hidden>
